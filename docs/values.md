...
## Our organization - mission & values

_Mission: Improve the lives of the people we serve by solving public problems differently_

And by "differently", we mean: **using participatory, evidence-based, and data-driven approaches and methods.**

The following values are shared organization-wide (not just within the engineering practice). You can expect all your team members to subscribe and adhere to these values.

As our organization, we are:

- **human-centered**: we put the user at the center of our problem-solving process, and we design with the people we serve, not just for them
...
The following are the Extreme Programming (XP) Values. We don't follow XP as a methodology/philosophy at large, but we have found that the values laid out in XP are well-aligned with our engineering discipline and we find them useful to leverage for our engineering values.
